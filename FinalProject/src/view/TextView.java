...
public class TextView extends JPanel implements Observer {
	...
	/**
	 * Instantiates a new text view. This is where all of the stats of the units
	 * are printed so that the user knows how much health they have as well as
	 * their attacks and more.
	 */
	public TextView() {
	...
	/**
	 * The map will call notifyObervers, and this method will update the stats
