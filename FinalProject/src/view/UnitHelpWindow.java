...
/**
 * The Class UnitHelpWindow. Displays Information about the controllable units
 * in the game.
 */
public class UnitHelpWindow extends JFrame implements Runnable {
	...
	/**
	 * Instantiates a new unit help window. Displays the information of each of
	 * the classes.
	 */
	public UnitHelpWindow() {
		...
		description
				.setText("About this Window: This Window shows the stats of each unit type.\n"
